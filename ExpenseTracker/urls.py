...
urlpatterns = [
    ...
    path('reset_password/',autho_views.PasswordResetView.as_view(template_name = "home/reset_password.html"),name='reset_password'),
...
# path() is used to route the url with the functions views in the app folder.
# include() returns an element to include that element in url patterns
